...
const PAGES = {
  ...
  index: { id: 'home', title: 'سەرکی', component: 'HomePage' },
  search: { id: 'search', title: 'Search results', component: 'SearchPage' },
  latest: { id: 'latest', title: 'بلاوکراوەی نوێ', component: 'LatestMediaPage' },
  featured: { id: 'featured', title: 'تایبەتمەند', component: 'FeaturedMediaPage' },
  recommended: { id: 'recommended', title: 'پێشنیارکراو', component: 'RecommendedMediaPage' },
  members: { id: 'members', title: 'Members', component: 'MembersPage' },
  history: { id: 'history', title: 'مێژوو', component: 'HistoryPage' },
  liked: { id: 'liked', title: 'میدیای دلخوازراو', component: 'LikedMediaPage' },
  tags: { id: 'tags', title: 'تاگەکان', component: 'TagsPage' },
